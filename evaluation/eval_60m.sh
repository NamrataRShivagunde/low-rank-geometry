...
# Simple launcher for 60m final checkpoints on up to 7 GPUs.
# Usage:
#   bash evaluation/eval_60m.sh
#   bash evaluation/eval_60m.sh "llama galore fira cola sltrain relora" "0,1,2,3,4,5,6"
#   bash evaluation/eval_60m.sh "llama cola" "0,1"

METHODS="${1:- llama galore fira cola sltrain relora}"
GPU_LIST_CSV="${2:-4,5,6}"
CONFIG="${3:-evaluation/configs/full_eval_all_tasks_new.yaml}"

MODEL_SIZE="60m"
CHECKPOINT_STEP="10000"
CHECKPOINT_BASE="CHECKPOINTS/models-60m"
