...
# Simple launcher for 130m final checkpoints on up to 7 GPUs.
# Usage:
#   bash evaluation/eval_130m.sh
#   bash evaluation/eval_130m.sh "llama galore fira cola sltrain relora" "0,1,2,3,4,5,6"
...
CHECKPOINT_BASE="CHECKPOINTS/models-130m"
