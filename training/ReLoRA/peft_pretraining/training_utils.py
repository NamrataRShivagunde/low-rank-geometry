...
from ReLoRA.peft_pretraining.modeling_llama import LlamaDecoderLayer
...
def optimizer_reset(
    ...
    *,
    ...
    reset_optimizer_on_relora: float,
    ...
    #     logger.info("Resetting 99% optimizer states to zeros")
    ...
    if optimizer_random_pruning != 0.0:
    ...
    elif optimizer_magnitude_pruning != 0.0:
