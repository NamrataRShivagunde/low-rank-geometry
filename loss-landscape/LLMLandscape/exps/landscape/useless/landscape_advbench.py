...
# model = Llama2().cuda()
model = Llama2("./results/fine-tuning-attack/default-4e-5-bf16/checkpoint-4/").cuda()
...
drawer = Landscape4Model(
    model, lambda m: test_vanilla_harmful_output_rate(m, loader, verbose=True), direction="Gaussian",
