...
import numpy as np
import math
from models import Qwen2, Llama31, Mistral, Llama2
...
worst_model = Llama2(f"./results/fine-tuning-attack/default-4e-5-bf16/checkpoint-4/")
model = Llama2()
...
for task in ["gsm8k"]:
    saving_name = task + "-" + "llama2-adversarial"
