...
class BaseModel(nn.Module):
    def __init__(
        ...
        generation_max_length: int = 3000,
        ...
        self.tie_weights = model.tie_weights if hasattr(model, "tie_weights") else None
    ...
    def generate(
        ...
        if generation_config is not None:
            g_config.update(generation_config)
    ...
    def generate_by_input_ids(self, input_ids: Tensor, *args, **kwargs) -> Tensor:
        ...
        :return: output_ids
        """
        result = self.model.generate(input_ids, *args, **kwargs)
        # import pdb
        # pdb.set_trace()
        return result
