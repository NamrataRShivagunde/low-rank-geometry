...
# 60M
CUDA_VISIBLE_DEVICES=6 python loss-landscape/scripts/multi_checkpoint_scripts/2_landscape_2d_PCA_multi_chkpt_60m.py \
  --num_directions 1 \
  ...
  --log_every 20 \
  --output_root results/loss-landscape-2d-PCA \
  --band_std_mult 1.0 \
...
# 130m
CUDA_VISIBLE_DEVICES=7 python loss-landscape/scripts/multi_checkpoint_scripts/2_landscape_2d_PCA_multi_chkpt_130m.py \
  --num_directions 1 \
  --c4_max_examples 1000 \
  --c4_batch_size 128 \
  --c4_max_length 256 \
...
# 350m
CUDA_VISIBLE_DEVICES=7 python loss-landscape/scripts/multi_checkpoint_scripts/2_landscape_2d_PCA_multi_chkpt_350m.py \
  --num_directions 1 \
  --c4_max_examples 1000 \
  --c4_batch_size 128 \
  --c4_max_length 256 \
