#!/bin/bash
# PCA top-20 directions for 350m WITHOUT sigma weighting (svd_weight_mode=none).
# Results go to results/pca-verification-k20-nosigma/350m/
#
# Usage: bash loss-landscape/scripts/bash_scripts/pca_top20_350m_nosigma.sh <GPU_ID> [method1 method2 ...]
set -euo pipefail
GPU_ID=${1:-4}
shift || true
...
echo "$(date '+%H:%M:%S') 350m nosigma done!"
