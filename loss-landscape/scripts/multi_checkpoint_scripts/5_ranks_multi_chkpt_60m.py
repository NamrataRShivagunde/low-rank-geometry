#!/usr/bin/env python3
"""Batch compute rank-related metrics for 60m checkpoints."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Batch compute rank metrics for 60m checkpoints")
    parser.add_argument(
        "--checkpoint_root",
        type=Path,
    ...
    parser.add_argument(
        "--output_root",
        type=Path,
        default=Path("results/rank-metrics-60m"),
    ...
    summary_json = summary_dir / "rank_metrics_60m_summary.json"
    summary_csv = summary_dir / "rank_metrics_60m_summary.csv"
