#!/usr/bin/env python3
"""Batch compute rank-related metrics for 130m checkpoints."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Batch compute rank metrics for 130m checkpoints")
    parser.add_argument(
        "--checkpoint_root",
        type=Path,
    ...
    parser.add_argument(
        "--output_root",
        type=Path,
        default=Path("results/rank-metrics/models-130m"),
    ...
    summary_json = summary_dir / "rank_metrics_130m_summary.json"
    summary_csv = summary_dir / "rank_metrics_130m_summary.csv"
