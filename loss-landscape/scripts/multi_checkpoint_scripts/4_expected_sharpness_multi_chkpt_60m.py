...
results/loss-landscape-2d-PCA/models-60m/ (or a custom root).
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Batch compute expected sharpness for 60m checkpoints")
    parser.add_argument(
        "--landscape_root",
        type=Path,
        default=Path("results/loss-landscape-2d-PCA/models-60m"),
    ...
    sharpness_summary_json = summary_dir / "expected_sharpness_60m_summary.json"
    sharpness_summary_csv = summary_dir / "expected_sharpness_60m_summary.csv"
    variance_summary_json = summary_dir / "average_variance_60m_summary.json"
    variance_summary_csv = summary_dir / "average_variance_60m_summary.csv"
