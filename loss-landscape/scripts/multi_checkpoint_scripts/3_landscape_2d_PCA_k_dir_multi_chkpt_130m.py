#!/usr/bin/env python3
"""
Batch script to run landscape analysis on all checkpoints in CHECKPOINTS/models-130m/

Structure:
    CHECKPOINTS/models-130m/
    ├── llama-60m/
    │   ├── model_1000/
    │   ├── model_2000/
    │   └── ...
...
Results are saved to:
    results/loss-landscape-2d/models-130m/
...
def main():
    parser = argparse.ArgumentParser(
        description="Batch run PCA top-k/component-range landscape analysis on all checkpoints in CHECKPOINTS/models-130m/"
    )
    
    parser.add_argument(
        "--checkpoint_root",
        type=Path,
        default=Path("CHECKPOINTS/models-130m"),
        help="Root directory containing all checkpoint folders (default: CHECKPOINTS/models-130m)"
    )
    parser.add_argument(
        "--output_root",
        type=Path,
