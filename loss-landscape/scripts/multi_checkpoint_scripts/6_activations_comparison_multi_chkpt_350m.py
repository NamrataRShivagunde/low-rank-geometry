#!/usr/bin/env python3
"""Batch compute activation-comparison metrics for 350m checkpoints vs llama baseline."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Batch compute activation comparison metrics for 350m")
    parser.add_argument("--checkpoint_root", type=Path, default=Path("CHECKPOINTS/models-350m"))
