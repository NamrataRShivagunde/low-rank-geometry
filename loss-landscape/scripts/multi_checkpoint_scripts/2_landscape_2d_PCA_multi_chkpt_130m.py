...
def main():
    parser = argparse.ArgumentParser(
        description="Batch run landscape analysis on all checkpoints in CHECKPOINTS/models-130m/"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="PCA component index for 2D_PCA mode (default: 1 for top component)"
    )
